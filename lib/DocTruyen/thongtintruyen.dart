...
import 'package:text_1/listruyen/truyenmoicapnhat/Api_truyenmoicapnhat.dart';
...
class Thongtintruyen extends StatelessWidget {
  Thongtintruyen({Key? key, required this.chitiet}) : super(key: key);
        ...
        children: [
          Container(
            ...
            child: Column(children: [
              ...
              Text('[Cập nhật lúc: ${chitiet.details[0].timer}]',
                  style: TextStyle(
